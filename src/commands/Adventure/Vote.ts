...
export const execute: SlashCommand["execute"] = async (ctx: InteractionCommandContext, userData: UserData) => {
    ...
    let content = `By [voting](https://top.gg/bot/923619190831730698/vote), you get **${Util.localeNumber(rewards.xp)}** <:xp:925111121600454706>, **${Util.localeNumber(rewards.money)}** <:jocoins:927974784187392061> and perhaps a **Mysterious Arrow** <:mysterious_arrow:924013675126358077> (10%)`;
